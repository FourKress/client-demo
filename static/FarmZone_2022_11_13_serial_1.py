...
if __name__ == '__main__':
    ...
    # '/Users/wudong/Works/python/GUI_Version'
    ...
    # '/Users/wudong/Works/python/settings/loc_turbines_initial.xlsx'
    ...
    # '/Users/wudong/Works/python/settings/boundary_0.xlsx'
    list_boundary_files.append(params['boundary_files'][0])

    # -------------------Label-3:flow fields-------------------#

    # select file
    # '/Users/wudong/Works/python/settings/vortex110.txt'
    dir_measured_wind = params['dir_measured_wind']
    # '/Users/wudong/Works/python/Data_zone_big_new/ground_zone_big_new_20221030.mat'
    dir_ground_file = params['dir_ground_file'] # Data_zone_big
    # '/Users/wudong/Works/python/Data_zone_big_new/mesh_zone_big_new_20221030.mat'
    ...
    # for each new adding,select file:
    # 0
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_0.mat')
    # list_wind_directions.append(270.0)
    # # 1
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_45.mat')
    # list_wind_directions.append(225.0)
    # # 2
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_90.mat')
    # list_wind_directions.append(180.0)
    # # 3
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_135.mat')
    # list_wind_directions.append(135.0)
    # # 4
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_180.mat')
    # list_wind_directions.append(90.0)
    # # 5
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_225.mat')
    # list_wind_directions.append(45.0)
    # # 6
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_270.mat')
    # list_wind_directions.append(0.0)
    # # 7
    # list_wind_files.append(
    #     '/Users/wudong/Works/python/Data_zone_big_new/wind_zone_big_new_20221030_angle_315.mat')
    # list_wind_directions.append(315.0)

    list_wind_files.append(
        params['wind_files'][0])
    list_wind_directions.append(float(params['wind_direction'][0]))
    list_wind_files.append(
        params['wind_files'][1])
    list_wind_directions.append(float(params['wind_direction'][1]))
    list_wind_files.append(
        params['wind_files'][2])
    list_wind_directions.append(float(params['wind_direction'][2]))
    list_wind_files.append(
        params['wind_files'][3])
    list_wind_directions.append(float(params['wind_direction'][3]))
    list_wind_files.append(
        params['wind_files'][4])
    list_wind_directions.append(float(params['wind_direction'][4]))
    list_wind_files.append(
        params['wind_files'][5])
    list_wind_directions.append(float(params['wind_direction'][5]))
    list_wind_files.append(
        params['wind_files'][6])
    list_wind_directions.append(float(params['wind_direction'][6]))
    list_wind_files.append(
        params['wind_files'][7])
    list_wind_directions.append(float(params['wind_direction'][7]))
